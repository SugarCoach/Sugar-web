<template>
    <main>
        <!-- <heroCircle
            ...
            color="#00C8DC"
            :button-text="$t('empresas.hero.ctaBtn')"
...
<script setup>
    ...
    useHead({
        ...
        meta: [
            ...
            {
                name: `keywords`,
                content: 'Empresas, Beneficios exclusivos, Apoyar el cuidado contra la diabetes, Suscripción paga, Patrocina'
            }
        ]
    })
    const imagenesYTextos = [
        {
            img_url: '/contenido/8-NinosconSC.webp',
