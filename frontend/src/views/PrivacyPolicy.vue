	...
	<q-page>
		<main class="mt-5 container">
			...
			<section>
				...
				<p>
					SugarCoach Diabetes Premium follows a standard procedure of
					using log files. These files log visitors when they use app.
			...
			<section>
				...
				<P
					...
					each of the advertising partners of SugarCoach Diabetes
					Premium.</P
				>
				...
				<p>
					...
					SugarCoach Diabetes Premium. They automatically receive your
					...
					on this app or other apps or websites.
				</p>

				<p>
					Note that SugarCoach Diabetes Premium has no access to or
			...
			<section>
				...
				<p>
					SugarCoach Diabetes Premium's Privacy Policy does not apply
					to other advertisers or websites. Thus, we are advising you
					to consult the respective Privacy Policies of these
					third-party ad servers for more detailed information. It may
					include their practices and instructions about how to
			...
			<section>
				...
				<p>
					...
					and is valid for visitors to our App with regards to the
					information that they shared and/or collect in SugarCoach
					Diabetes Premium. This policy is not applicable to any
					information collected offline or via channels other than
					this app. Our Privacy Policy was created with the help of
					the
					<a
