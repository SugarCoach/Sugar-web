<template>
    <!-- Modal -->
    <div class="modal fade text-bg-secondary" id="modal_pago" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content bg-dark" style="box-shadow: 0 0 30px rgb(0, 23, 24); min-width: 40vw;">
                ...
                <div class="modal-body">
                    ...
                    <form action="https://formsubmit.co/admin.team@sugar.coach" method="POST" class="mt-4">
