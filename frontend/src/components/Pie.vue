<template>
	<div style="background: linear-gradient(180deg, rgba(34,53,77,0) 15%, #39B6BB 100%); width: 100%; height: 250px;">
	</div>
	<div class="estrellas">
		<div class="container">
			<footer class="row row-cols-1 row-cols-sm-2 row-cols-md-3">
				<div class="col">
					<router-link to="/" aria-label="Ir al inicio"
						...
						<img class="m-auto mb-0" width="100" loading="lazy" src="../../public/contenido/sugar-logo.webp"
							alt="Logo SugarCoach">
					</router-link>
					<p class="text-body-secondary h4 ">&copy; SugarCoach Diabetes Premium, Inc 2024</p>
				</div>
				<div class="col">
...
.estrellas {
	...
	height: auto;
	min-height: 100%;
	background-image: url('../../public/contenido/space_bg_footer.webp');
