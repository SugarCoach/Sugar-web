<template>
    <sugarHeader v-if="!($route.path === '/isa' || $route.path == '/lab')" :bg-color="$route.path === '/anunciantes' ? '#010620' : 'white'" :color="$route.path === '/anunciantes' ? 'white' : ''"></sugarHeader>
    <router-view />
    ...
    <img src="../public/contenido/sugar-logo.png" alt="Logo girando" width="512" height="512" loadging="lazy" decoding="async"></div>-->
    <sugarFooter v-if="!($route.path === '/isa' || $route.path == '/lab')" :bg-color="$route.path === '/anunciantes' ? '#010416' : 'white'" :color="$route.path === '/anunciantes' ? 'white' : ''"></sugarFooter>
</template>

<script setup>
    import sugarHeader from './components/sugarHeader.vue'
    import sugarFooter from './components/sugarFooter.vue'
    // import { defineAsyncComponent } from "vue";
    import { computed, reactive, ref } from 'vue'
    import { useHead } from '@vueuse/head'
    name: 'App'
    components: {
        sugarHeader, sugarFooter
    }
