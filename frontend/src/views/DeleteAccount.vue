            ...
            <div class="d-flex flex-column gap-3 w-100 mb-4">
                ...
                <div v-for="item in inputs" :key="item.id" class="w-100">
                    ...
                    <input
                        autocomplete=""
                        :id="item.for"
                        class="form-control message rounded-4 border border-1 border-black border-opacity-50"
                        :name="item.for"
                        :type="item.type"
                        :placeholder="$t('borrarCuenta.inputs[' + item.id + '].placeholder') + item.placeholder"
                    />
                </div>
            </div>
