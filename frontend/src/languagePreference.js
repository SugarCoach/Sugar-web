const messages = {
    es: {
        ...
        home: {
            ...
            nuestraApp: {
                ...
                pantallas: [
                    ...
                    },
                    {
                        ...
                        texto: 'Es muy común que la diabetes se presenta en niños desde corta edad. Por lo tanto, el control lo realizan los adultos responsables y pueden llevarlo varios integrantes de la familia. SugarCoach envía mensajes automáticos para alertar un episodio de hipoglucemia o hiperglucemia grave.',
                    },
                    {
                        title: 'Con informes claros y útiles para el médico sobre la hemoglobina glicosilada (HbA1c)',
                        texto: 'SugarCoach envía informes regulares al equipo médico para el seguimiento de la diabetes. Además cuenta con gráficos y estadísticas simples y útiles donde contrastar el desarrollo de la glucemia a lo largo del tiempo. Además permite la telemedicina.',
                    }
                ],
            },
            descargarApp: '¡Descarga la app ya!',
            mejorarExperiencia: {
                h2: '¡Mejora tu experiencia!',
            ...
            planes: {
                ...
                linkPremium: {
                    h4: '¡Consigue tu licencia Premium ahora!',
                    texto: 'Premium',
                },
                linkPremios: {
                    h4: '¿Buscas Otra cosa?',
            ...
            novedades: {
                ...
                h3: 'Sumate a nuestras redes sociales',
            },
            contactanos: {
                h2: 'Contactanos',
        ...
        premium: {
            hero: {
                h1: 'Premium',
                h2: 'Recibe más ayuda para combatir la diabetes',
    ...
    en: {
        ...
        home: {
            ...
            descargarApp: 'Download the App now!',
            mejorarExperiencia: {
                h2: 'Improve your experience!',
            ...
            novedades: {
                h2: 'Follow our updates',
                h3: 'Join our social media',
            },
            contactanos: {
                h2: 'Contact us',
                p: 'To learn more about us and SugarCocah, you can write to us or follow the community on social media',
                ctaBtn: 'About',
                ctaBtnUrl: '/about',
                inputs: [
                    {
        ...
        politica: {
            header: {
                h1: 'Privacy Policy for SugarCoach Diabetes Premium',
                p: 'At SugarCoach Diabetes Premium, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by SugarCoach Diabetes Premium and how we use it. <br><br>If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.',
            },
            sections: [
                {
                    h2: 'Log Files',
                    p: 'SugarCoach Diabetes Premium follows a standard procedure of using log files. These files log visitors when they use app. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the app, tracking users\' movement on the app, and gathering demographic information.',
                },
                {
                    h2: 'Our Advertising Partners',
